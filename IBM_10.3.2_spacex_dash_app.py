...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(id='payload-slider',
                                                    ...
                                                    max=int(max_payload),
                                                    step=1000,
                                                    marks={int(i): '{}'.format(int(i)) for i in range(int(min_payload), int(max_payload) + 1, 1000)},
...
def update_pie_chart(selected_site):
    if selected_site == 'ALL':
        ...
        fig = px.pie(selected_data, names='class', title=f'Success Rate for {selected_site}')
    return fig
